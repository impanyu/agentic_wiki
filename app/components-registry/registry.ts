...
export type AgentContext={pageId?:string;userId:string;language:string;ownerId:string;visibility:'public'|'private';pageIntent?:'article'|'chart'|'application';agent?:Agent};
