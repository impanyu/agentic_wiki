...
export type AgentContext={plannedPageId?:string;pendingFiles?:{fileId:string;componentId:string;folder:string}[];indexLeafRequired?:boolean;toolFindings?:unknown;sourceDocument?:SourceDocument;generationIntent?:GenerationIntent;generationFeedback?:string;pageId?:string;userId:string;language:string;ownerId:string;visibility:'public'|'private';pageIntent?:'article'|'chart'|'application';agent?:Agent};
