...
const definitions=[
 ...
 tool('find_images','Find actual illustration URLs and attribution. Inspect metadata and select only images matching the requested subject and scope; never relabel an unrelated image.',{query:string}),
...
const writeTools=new Set(['execute_code','use_computer','remember_component','link_components','execute_api']);
