...
const definitions=[
 ...
 tool('read_generation_contract','Read the complete page artifact contract for an app revision: kind "draft" returns the whole page draft format plus the generator guidance; program, chart, form, converter and custom_style return those payload formats.',{kind:string}),
...
const writeTools=new Set(['copy_resources','execute_code','use_computer','remember_component','link_components','execute_api']);
