...
export function PaperWorkspace({pageId,body,sources,revision=0,children}:{pageId:string;body:string;sources:PaperSource[];revision?:number;children:ReactNode}){
