export const templates=[
 ...
 {id:'files-v1',name:'File browser',description:'Browse actual files and folders in a hierarchy: breadcrumbs, search, sorting, list/grid views. Supports uploaded data and connected Google Drive folders.',kind:'application',keywords:'files folders directory drive hierarchy documents 文件 文件夹 目录 层级 上传'},
