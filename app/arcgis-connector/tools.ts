...
const str={type:'string'},int={type:'integer'},item={itemId:str},resource={type:'object',properties:{space:{type:'string',enum:['page','adma','google','dropbox','onedrive','hcc','adapt']},id:str,name:str,kind:{type:'string',enum:['file']},connectorId:str},required:['space','id','name','kind'],additionalProperties:false};
