export type AnswerPage = {
  ...
  question?: string;
  language: string;
  labels: {indexEntries?:import('./disambiguation/view').IndexEntry[];templateId?:import('./templates/catalog').TemplateId;overview?:string;contents?:string;sources?:string};
  title: string;
  summary: string;
  body: string;
  category: string;
