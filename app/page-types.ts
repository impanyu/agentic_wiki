export type AnswerPage = {
  ...
  question?: string;
  language: string;
  labels: {routingFresh?:boolean;richContent?:import('./page-editor/document').RichNode;richBody?:string;sourceMedia?:import('./url-content/media').SourceMedia[];sourceUrl?:string;sourceSummary?:string;indexEntries?:import('./disambiguation/view').IndexEntry[];templateId?:import('./templates/catalog').TemplateId;overview?:string;contents?:string;sources?:string};
  title: string;
  summary: string;
  body: string;
  category: string;
