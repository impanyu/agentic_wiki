...
globalThis.draftFrontend=frontend;const pageCode=await load('const z=globalThis.draftZod;const {sandboxSchema}=globalThis.draftFrontend;\n'+strip('app/page-programs/page-code.ts'));
